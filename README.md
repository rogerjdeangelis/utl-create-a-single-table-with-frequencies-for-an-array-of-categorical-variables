# utl-create-a-single-table-with-frequencies-for-an-array-of-categorical-variables
    ...
    variables and output this data in a new data set?"                                                                              
        ...
        Eight Soltions                                                                                                              
         ...
         d. through g. produce the following output                                                                                 
                                                         NEITHER_                                                                   
         ...
         e. Level descriptions across (see output below most flexible for fat output)                                               
             Nat Wooding                                                                                                            
             nathani@verizon.net                                                                                                    
    ...
    *                                                                                                                               
    ...
    Did I missed something or there is no 2-dim array (questions by levels) solution?                                               
    ...
    * used with solution b;                                                                                                         
    data have;                                                                                                                      
      infile cards4 EOF=EOF;                                                                                                        
      input id A1Q1 A2Q1 RFQ1 SE1Q1 SE2Q1 SE3Q1 SE4Q1 I1Q1 I2Q1 I3Q1 ;                                                              
                                                                                                                                    
      array variables A1Q1 -- I3Q1;                                                                                                 
      array survey[1:10, 1:5] (%eval(10*5)*0);                                                                                      
                                                                                                                                    
      do over variables;                                                                                                            
       survey[_I_, variables] + 1;                                                                                                  
      end;                                                                                                                          
    ...
    EOF:                                                                                                                            
      do over variables;                                                                                                            
        do _N_ = 1 to 5;                                                                                                            
          v = vname(variables);                                                                                                     
          put @1 v @7 _N_ $lvl2des. @40 survey[_I_, _N_];                                                                           
        end;                                                                                                                        
      end;                                                                                                                          
    cards4;                                                                                                                         
    1 2 1 1 3 3 4 2 5 3 2                                                                                                           
